...
// and the pen wins.
//
// Two rows now, not five. Weight, temperature and supplement left for tiles of
// their own (D-038), the way sleep did before them — they each capture
// something, and a type buried in a list was the wrong shape for that. What is
// left has no value to capture: pick one, write the rest in the note.
